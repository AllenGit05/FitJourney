...
import com.example.fitjourneyag.ui.theme.FJTextPrimary
import com.example.fitjourneyag.ui.theme.FJTextSecondary
...
@Composable
fun MeasurementLogCard(log: com.example.fitjourneyag.domain.model.BodyMeasurement, onDelete: () -> Unit) {
    Surface(
        color = FJSurface,
