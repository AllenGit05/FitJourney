...
class ProgressViewModel(
    ...
    val bodyMeasurements: StateFlow<List<com.example.fitjourneyag.domain.model.BodyMeasurement>> = progressRepository.bodyMeasurements
    ...
    fun deleteMeasurement(measurement: com.example.fitjourneyag.domain.model.BodyMeasurement) {
        viewModelScope.launch {
