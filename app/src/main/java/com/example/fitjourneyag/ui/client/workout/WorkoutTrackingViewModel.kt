package com.example.fitjourneyag.ui.client.workout
    ...
    fun calculateSessionCaloriesAI() {
        ...
        viewModelScope.launch {
            ...
            try {
                ...
                val resultText = when {
                    groq != null -> callGroq(prompt, groq.apiKey)
                    gemini != null -> callGemini(prompt, gemini.apiKey)
                    else -> throw Exception("No active AI provider found")
                }
