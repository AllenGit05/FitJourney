        ...
        try {
            when (json.getString("tool")) {
                ...
                "add_food" -> {
                    ...
                    dietRepository.addFood(com.example.fitjourney.domain.repository.FoodLogEntry(
                        name = name, 
                        calories = calories, 
                        protein = protein, 
                        carbs = carbs, 
                ...
                "add_workout" -> {
                    ...
                    for (i in 0 until exercisesJson.length()) {
                        ...
                        for (j in 0 until setsJson.length()) {
                            ...
                            sets.add(com.example.fitjourney.domain.model.WorkoutSet(
                                reps = setObj.getInt("reps"),
                                weight = setObj.getDouble("weight").toFloat(),
                                isCompleted = true
                            ))
                        }
                        exercises.add(com.example.fitjourney.domain.model.Exercise(
                    ...
                    workoutRepository.saveWorkout(com.example.fitjourney.domain.model.WorkoutSession(
