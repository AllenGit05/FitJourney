...
import com.example.fitjourney.ui.client.ClientDashboardScreen
import com.example.fitjourney.ui.client.ai.AiCoachScreen
import com.example.fitjourney.ui.client.progress.ProgressScreen
import com.example.fitjourney.ui.client.track.TrackScreen
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(Screen.ClientDashboard.route) {
                val viewModel: com.example.fitjourney.ui.client.ClientDashboardViewModel = androidx.lifecycle.viewmodel.compose.viewModel(
            ...
            composable(Screen.ClientTrack.route) {
                val viewModel: com.example.fitjourney.ui.client.track.TrackViewModel = androidx.lifecycle.viewmodel.compose.viewModel(
                    factory = com.example.fitjourney.di.AppViewModelProvider.Factory
                )
                TrackScreen(
                    viewModel = viewModel,
