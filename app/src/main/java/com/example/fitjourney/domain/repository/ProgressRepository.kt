...
interface ProgressRepository {
    ...
    val stepsHistory: StateFlow<List<com.example.fitjourney.domain.model.StepsEntry>>
    val bodyMeasurements: StateFlow<List<com.example.fitjourney.domain.model.BodyMeasurement>>
    ...
    suspend fun deleteSteps(entry: com.example.fitjourney.domain.model.StepsEntry)
    suspend fun deleteProgressPhoto(photo: ProgressPhoto)
    suspend fun deleteMeasurement(measurement: com.example.fitjourney.domain.model.BodyMeasurement)
}
